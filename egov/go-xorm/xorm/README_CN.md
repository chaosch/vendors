...
[English](https://egov/go-xorm/xorm/blob/master/README.md)
...
* **v0.6.0**
    * 去除对 ql 的支持
    * 新增条件查询分析器 [egov/go-xorm/builder](https://egov/go-xorm/builder), 从因此 `Where, And, Or` 函数
...
[更多更新日志...](https://egov/go-xorm/manual-zh-CN/tree/master/chapter-16)
...
* [GoWalker代码文档](http://gowalker.org/egov/go-xorm/xorm)

* [Godoc代码文档](http://godoc.org/egov/go-xorm/xorm)
...
如果您也想为Xorm贡献您的力量，请查看 [CONTRIBUTING](https://egov/go-xorm/xorm/blob/master/CONTRIBUTING.md)
