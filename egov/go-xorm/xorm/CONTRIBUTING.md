...
[base.go](https://egov/go-xorm/tests/blob/master/base.go) AND
[benchmark.go](https://egov/go-xorm/tests/blob/master/benchmark.go).

If you implements a new database interface, you maybe need to add a <databasename>_test.go file.
For example, [mysql_test.go](https://egov/go-xorm/tests/blob/master/mysql/mysql_test.go)
