[中文](https://egov/go-xorm/xorm/blob/master/README_CN.md)
...
* Database Reverse support, See [Xorm Tool README](https://egov/go-xorm/cmd/blob/master/README.md)

* Simple cascade loading support

* Optimistic Locking support

* SQL Builder support via [egov/go-xorm/builder](https://egov/go-xorm/builder)
...
* **v0.6.0**
    ...
    * add query condition builder support via [egov/go-xorm/builder](https://egov/go-xorm/builder), so `Where`, `And`, `Or`
...
[More changes ...](https://egov/go-xorm/manual-en-US/tree/master/chapter-16)

# Installation

	go get egov/go-xorm/xorm

# Documents

* [Manual](http://xorm.io/docs)

* [GoDoc](http://godoc.org/egov/go-xorm/xorm)

* [GoWalker](http://gowalker.org/egov/go-xorm/xorm)
...
If you want to pull request, please see [CONTRIBUTING](https://egov/go-xorm/xorm/blob/master/CONTRIBUTING.md)
